 ...
 * 请根据实际的业务情况添加需要测试的方法
 */
public class BusinessParamItemServiceImplTest extends AbstractTestWrapper {

    @Resource
    private BusinessParamItemService service;

    private Logger logger = Logger.getLogger(BusinessParamItemServiceImplTest.class);
