 ...
 */
(function (angular) {
    var app = angular.module("eccrm.organi.organiEmp", ['ngResource', 'mgcrea.ngStrap', 'eccrm.angularstrap']);
    app.service('OrganiEmpService', function ($resource,CommonUtils) {
        return $resource(CommonUtils.contextPathURL('/wanda/orgEmp/:id/:method'), {}, {
            //保存
