...
<head>
    ...
    <script type="text/javascript" src="<%=contextPath%>/app/spec/member/member_approve.js"></script>
                    ...
                    <div class="table-responsive panel panel-table  first-min">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in employees.data">
                                ...
                                <td>
                                    <a class="cp" ng-click="accept(foo.id)" title="通过">
                                        <i class="icons ok"></i>
                                    </a>
                                    <a class="cp" ng-click="deny(foo.id)" title="不通过！">
