    ...
    <div class="row-10">
        <div class="block">
            <div class="block-header">
                    ...
                    class="header-button">
                         <a type="button"
                            class="btn btn-sm btn-green btn-min" ng-click="reply(beans.id)"
                            ng-if="beans.needReply && beans.status !='2'" ng-cloak>
                         <span class="glyphicons edit"></span> 回复 </a>
                ...
                <div class="content-wrap">
                    <form name="form" class="form-horizontal" role="form">
                        ...
                        <div class="row">
                            ...
                            <span class="middle">{{beans.isread?'是':'否'}}</span>
                        </div>
