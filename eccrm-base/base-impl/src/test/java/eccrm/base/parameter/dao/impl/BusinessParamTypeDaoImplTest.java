 ...
 */
public class BusinessParamTypeDaoImplTest extends AbstractTestWrapper {

    @Resource
    private BusinessParamTypeDao dao;

    private Logger logger = Logger.getLogger(BusinessParamTypeDaoImplTest.class);

    @Before
    public void setUp() throws Exception {
        logger.info(" test eccrm.base.parameter.dao.impl.BusinessParamTypeDaoImpl ......");
    }
