...
<body>
<div class="main condition-row-3" id="pageTab" ng-app="eccrm.org.orgEmpAdd" ng-controller="OrgEmpAddController" >
...
<script type="text/javascript" src="app/org/empTemp.js" ></script >
<script type="text/javascript" src="app/org/orgTemp.js" ></script >
<script type="text/javascript" src="app/org/list/orgEmpAdd.js" ></script >
